...
irf1 <- irf(var1, impulse="YUS", response = "SUS", boot=TRUE, n.ahead =40, ci=0.84, runs=100)
...
plot(irf(svar.one, impulse = "SUS", response = "SUS", n.ahead=40, boot=TRUE, ortho=TRUE, ci=0.84))
